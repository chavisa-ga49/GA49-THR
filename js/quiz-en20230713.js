  ...
  $(this).siblings('.radio-button-field').addClass('not-check');
    ...
    switch(ansResult) {
      case "x,1,a":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/blt-jas-old100');        
        break;
      case "x,1,b":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/lth-jas-hommali');
        break;
      case "x,1,c":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/lth-aro-surin');
        break;
      case "x,1,d":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/blt-hty-hommunpu');
        break;
      case "x,2,a":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/blt-bkn-tonmali');
        break;
      case "x,2,b":
      ...
      case "x,2,d":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/blt-hty-red100');
        break;
      case "x,3,a":
      ...
      case "x,3,b":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/cdo-jas-hommali');
        break;
      case "x,3,c":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/lts-wht-taheang100');
        break;
      case "x,3,d":
      ...
      case "x,4,a":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/lth-jas-gold');
        break;
      case "x,4,b":
      ...
      case "x,4,c":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/lth-wht-taheang100');
        break;
      case "x,4,d":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/blt-hty-brownjamine100');
        break;
      case "y,5,a":
      ...
      case "y,5,c":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/cdg-aro-special');
        break;
      case "y,5,d":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/lts-hty-hommalired');
        break;
      case "y,6,a":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/ltg-aro-mixed');
        break;
      case "y,6,b":
      ...
      case "y,6,c":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/lth-wht-saohai');
        break;
      case "y,6,d":
      ...
      case "y,7,a":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/bjm-jas-old100');
        break;
      case "y,7,b":
      ...
      case "y,7,c":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/lth-aro-100');
        break;
      case "y,7,d":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/lts-hty-healthy');
        break;
      case "y,8,a":
        ...
        $(".quiz-result-btn").attr('href', '/en/product/blt-jas-new100');
        break;
      case "y,8,b":
